...
class BloggerConfig(BaseSettings):
    ...
    blog_structure: str = Field(default=DEFAULT_BLOG_STRUCTURE, min_length=1, max_length=500)
    ...
    executor_llm: str = Field(default="marco-o1", min_length=1, max_length=100)
